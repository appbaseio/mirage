System.register(['@angular/core/testing', './term.query'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var testing_1, term_query_1;
    return {
        setters:[
        ...
        execute: function() {
            testing_1.describe('Term query format', function () {
                // Set initial things
                ...
                testing_1.beforeEach(function () {
                    query = new term_query_1.TermQuery();
            ...
            testing_1.describe("xhr test (Term)", function () {
                var returnedJSON = {};
                var status = 0;
                testing_1.beforeEach(function (done) {
                    var query = new term_query_1.TermQuery();
                    query.queryName = 'term';
                    query.fieldName = 'name';
                    query.inputs = {
                        input: {
...
//# sourceMappingURL=term.query.spec.js.map