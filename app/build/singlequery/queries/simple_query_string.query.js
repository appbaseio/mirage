System.register(["@angular/core", '../../editable/editable.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, editable_component_1;
    var SimpleQueryStringQuery;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            SimpleQueryStringQuery = (function () {
                function SimpleQueryStringQuery() {
                    this.getQueryFormat = new core_1.EventEmitter();
                    this.current_query = 'simple_query_string';
                    this.queryName = '*';
                    this.fieldName = '*';
                    this.information = {
                ...
                */
                SimpleQueryStringQuery.prototype.getFormat = function () {
                    if (this.queryName === this.current_query) {
                        this.queryFormat = this.setFormat();
                        this.getQueryFormat.emit(this.queryFormat);
                    }
                };
                SimpleQueryStringQuery.prototype.setFormat = function () {
                    var queryFormat = {};
                ...
                ], SimpleQueryStringQuery.prototype, "queryList", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', String)
                ], SimpleQueryStringQuery.prototype, "selectedField", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
                ], SimpleQueryStringQuery.prototype, "appliedQuery", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', String)
                ], SimpleQueryStringQuery.prototype, "selectedQuery", void 0);
                __decorate([
                    core_1.Output(), 
                    __metadata('design:type', Object)
                ], SimpleQueryStringQuery.prototype, "getQueryFormat", void 0);
                SimpleQueryStringQuery = __decorate([
                    core_1.Component({
            ...
            exports_1("SimpleQueryStringQuery", SimpleQueryStringQuery);
        }
    }
});
