System.register(['@angular/core/testing', './ids.query'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var testing_1, ids_query_1;
    return {
        setters:[
        ...
        execute: function() {
            testing_1.describe('ids query format', function () {
                // Set initial things
                // set expected query format
                var query;
                var expectedFormat = {
                    'ids': {
                        'values': ['AVV7O_hNLozDpnHtfPQL'],
                        'type': ['test']
                    }
                };
                // instantiate query component and set the input fields 
                testing_1.beforeEach(function () {
                    query = new ids_query_1.IdsQuery();
                    query.queryName = 'ids';
                    query.fieldName = '';
                    query.selectedTypes = ['test'];
                    query.inputs = {
                        input: {
                            value: 'AVV7O_hNLozDpnHtfPQL'
                        }
                    };
                });
            ...
            testing_1.describe("xhr test (ids)", function () {
                var returnedJSON = {};
                var status = 0;
                testing_1.beforeEach(function (done) {
                    var query = new ids_query_1.IdsQuery();
                    query = new ids_query_1.IdsQuery();
                    query.queryName = 'ids';
                    query.fieldName = '';
                    query.selectedTypes = ['test'];
...
//# sourceMappingURL=ids.query.spec.js.map