System.register(['@angular/core/testing', './query_string.query', '../../../shared/appbase.service', '@angular/http'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var testing_1, query_string_query_1, appbase_service_1, http_1;
    return {
        setters:[
        ...
        execute: function() {
            testing_1.describe('Query string format', function () {
                ...
                testing_1.beforeEach(function () {
                    query = new query_string_query_1.QueryStringQuery();
            ...
            testing_1.describe("xhr test (query_string)", function () {
                var returnedJSON = {};
                var status = 0;
                testing_1.beforeEach(function (done) {
                    var query = new query_string_query_1.QueryStringQuery();
                    query.queryName = 'query_string';
                    query.fieldName = 'name';
                    query.inputs = {
                        input: {
...
//# sourceMappingURL=query_string.query.spec.js.map