"use strict";
var geodistancerange_query_1 = require('./geodistancerange.query');
describe('geo_distance_range query format', function () {
    // Set initial things
    ...
    beforeEach(function () {
        query = new geodistancerange_query_1.GeoDistanceRangeQuery();
        query.queryName = 'geo_distance_range';
...
describe("xhr test (geo_distance_range)", function () {
    ...
    beforeEach(function (done) {
        var query = new geodistancerange_query_1.GeoDistanceRangeQuery();
        query.queryName = 'geo_distance_range';
...
//# sourceMappingURL=geodistancerange.query.spec.js.map