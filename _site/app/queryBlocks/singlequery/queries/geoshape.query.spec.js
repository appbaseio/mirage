"use strict";
var geoshape_query_1 = require('./geoshape.query');
describe('geo_shape query format', function () {
    // Set initial things
    ...
    beforeEach(function () {
        query = new geoshape_query_1.GeoShapeQuery();
...
describe("xhr test (geo_shape)", function () {
    ...
    beforeEach(function (done) {
        var query = new geoshape_query_1.GeoShapeQuery();
        query.queryName = 'geo_shape';
...
//# sourceMappingURL=geoshape.query.spec.js.map