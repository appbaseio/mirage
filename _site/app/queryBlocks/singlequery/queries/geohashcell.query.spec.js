"use strict";
var geohashcell_query_1 = require('./geohashcell.query');
describe('geohash_cell query format', function () {
    // Set initial things
    ...
    beforeEach(function () {
        query = new geohashcell_query_1.GeoHashCellQuery();
...
describe("xhr test (geohash_cell)", function () {
    ...
    beforeEach(function (done) {
        var query = new geohashcell_query_1.GeoHashCellQuery();
        query.queryName = 'geohash_cell';
        query.fieldName = 'location_hash';
        query.inputs = {
            lat: {
...
//# sourceMappingURL=geohashcell.query.spec.js.map