"use strict";
var geopolygon_query_1 = require('./geopolygon.query');
describe('geo_polygon query format', function () {
    // Set initial things
    ...
    beforeEach(function () {
        query = new geopolygon_query_1.GeoPolygonQuery();
...
describe("xhr test (geo_polygon)", function () {
    ...
    beforeEach(function (done) {
        var query = new geopolygon_query_1.GeoPolygonQuery();
        query.queryName = 'geo_polygon';
...
//# sourceMappingURL=geopolygon.query.spec.js.map