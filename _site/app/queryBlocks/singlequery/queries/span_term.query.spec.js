"use strict";
var span_term_query_1 = require('./span_term.query');
describe('SpanTerm query format', function () {
    // Set initial things
    ...
    beforeEach(function () {
        query = new span_term_query_1.SpanTermQuery();
...
describe("xhr test (SpanTerm)", function () {
    ...
    beforeEach(function (done) {
        var query = new span_term_query_1.SpanTermQuery();
        query.queryName = 'span_term';
        query.fieldName = 'gender';
        query.inputs = {
            input: {
...
//# sourceMappingURL=span_term.query.spec.js.map