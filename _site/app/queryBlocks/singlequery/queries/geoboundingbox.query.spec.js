"use strict";
var geoboundingbox_query_1 = require('./geoboundingbox.query');
describe('geo_bounding_box query format', function () {
    // Set initial things
    ...
    beforeEach(function () {
        query = new geoboundingbox_query_1.GeoBoundingBoxQuery();
...
describe("xhr test (geo_bounding_box)", function () {
    ...
    beforeEach(function (done) {
        var query = new geoboundingbox_query_1.GeoBoundingBoxQuery();
        query.queryName = 'geo_bounding_box';
...
//# sourceMappingURL=geoboundingbox.query.spec.js.map