"use strict";
var span_first_query_1 = require('./span_first.query');
describe('SpanFirst query format', function () {
    // Set initial things
    ...
    beforeEach(function () {
        query = new span_first_query_1.SpanFirstQuery();
        query.queryName = 'span_first';
...
describe("xhr test (SpanFirst)", function () {
    var returnedJSON = {};
    var status = 0;
    beforeEach(function (done) {
        var query = new span_first_query_1.SpanFirstQuery();
        query.queryName = 'span_first';
        query.fieldName = 'gender';
        query.inputs = {
            input: {
...
//# sourceMappingURL=span_first.query.spec.js.map